...
class TestCFIntegration(BaseTestCase):
    ...
    def test_ocos(self):
        ...
        msgs = [
            ...
            u"units (None) attribute of 's_w' must be a string", 
            u"units (None) attribute of 's_rho' must be a string", 
            u"units (None) attribute of 'Cs_w' must be a string", 
            u"units (None) attribute of 'user' must be a string", 
            u"units (None) attribute of 'Cs_r' must be a string", 
    ...
    def test_ooi_glider(self):
        ...
        msgs = [
           u'§2.6.2 comment global attribute should be a non-empty string', 
           u"units (None) attribute of 'deployment' must be a string", 
    ...
    def test_pr_inundation(self):
        ...
        msgs = [
            ...
            u'§2.6.2 comment global attribute should be a non-empty string', 
            u"units (None) attribute of 'LayerInterf' must be a string",
            u"units (None) attribute of 'time_bounds' must be a string",
            u"units (None) attribute of 'Layer' must be a string", 
