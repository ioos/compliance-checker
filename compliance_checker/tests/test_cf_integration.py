...
class TestCFIntegration(pytestBaseTest):
    ...
    def get_results(self, check_results,checksuite):
        ...
        """
        aggregation = checksuite.build_structure("cf", check_results["cf"][0], "test", 1)
        out_of = 0
        scored = 0
    ...
    @pytest.mark.parametrize('loaded_dataset,expected_messages',dataset_stem__expected_messages,
    ...
    @pytest.mark.parametrize('loaded_dataset,wrong_message',
    ...
    @pytest.mark.parametrize('loaded_dataset',["NCEI_profile_template_v2.0_2016-09-22_181835.151325"],indirect=True)
