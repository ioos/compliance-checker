...
def main():
    ...
    parser.add_argument('-f', '--format', default='stdout', choices=['stdout', 'html'], help='Output format')
    parser.add_argument('-o', '--output', default='stdout', action='store', help='Output filename')
